...
def main():
    ...
    time.sleep(3)
    # p1
    s.send(bytes("movel(pose_trans({},p[0.058,-0.08,0,0,0,0]),1,0.1,0,0)".format(current_pose) + "\n", "utf-8"))
    time.sleep(3)
    # drop pen
    s.send(bytes("movel(pose_trans({},p[0.058,-0.08,0.0035,0,0,0]),1,0.1,0,0)".format(current_pose) + "\n", "utf-8"))
    time.sleep(3)
    # p2
    s.send(bytes("movel(pose_trans({},p[-0.095,0.03,0.0035,0,0,0]),1,0.1,0,0)".format(current_pose) + "\n", "utf-8"))
    time.sleep(3)
    # p3
    s.send(bytes("movel(pose_trans({},p[0.095,0.03,0.0035,0,0,0]),1,0.1,0,0)".format(current_pose) + "\n", "utf-8"))
    time.sleep(3)
    ...
    time.sleep(3)
    # p5
    s.send(bytes("movel(pose_trans({},p[0.0,0.10,0.0035,0,0,0]),1,0.1,0,0)".format(current_pose) + "\n", "utf-8"))
    time.sleep(3)
    # p1
    s.send(bytes("movel(pose_trans({},p[0.058,-0.08,0.0035,0,0,0]),1,0.1,0,0)".format(current_pose) + "\n", "utf-8"))
    time.sleep(3)
